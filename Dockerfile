...
RUN curl -o xampp-linux-installer.run "https://downloadsapachefriends.global.ssl.fastly.net/xampp-files/7.0.33/xampp-linux-x64-7.0.33-0-installer.run?from_af=true"
